...
`ifdef LEDTEST
// Used to verify correct LED assignment, Open_Collector[1] is LS bit
wire [3:0] led_cnt;
assign led_cnt = {Open_Collector[4],Open_Collector[3],Open_Collector[2],Open_Collector[1]};

assign DEBUG_LED1 = (led_cnt[3:0] == 4'd1) ? 1'b0 : 1'b1;
assign DEBUG_LED2 = (led_cnt[3:0] == 4'd2) ? 1'b0 : 1'b1;
assign DEBUG_LED3 = (led_cnt[3:0] == 4'd3) ? 1'b0 : 1'b1;
assign DEBUG_LED4 = (led_cnt[3:0] == 4'd4) ? 1'b0 : 1'b1;
assign DEBUG_LED5 = (led_cnt[3:0] == 4'd5) ? 1'b0 : 1'b1;
assign DEBUG_LED6 = (led_cnt[3:0] == 4'd6) ? 1'b0 : 1'b1;
assign DEBUG_LED7 = (led_cnt[3:0] == 4'd7) ? 1'b0 : 1'b1;
assign DEBUG_LED8 = (led_cnt[3:0] == 4'd8) ? 1'b0 : 1'b1;
assign DEBUG_LED9 = (led_cnt[3:0] == 4'd9) ? 1'b0 : 1'b1;
assign DEBUG_LED10 = (led_cnt[3:0] == 4'd10) ? 1'b0 : 1'b1;
